...
plan-basic-description = Basic — максимально { $limit } валют
plan-standard-description = Standard — максимально { $limit } валют
plan-premium-description = Premium — максимально { $limit } валют
...
price-star = { $price } ⭐
#payment
subscription-payment-button = Отправить { $price } ⭐️
subscription-invoice-title = Подписка { $plan }
subscription-invoice-description = Оформите подписку { $plan } на 30 дней
subscription-price-label = Подписка { $plan }
#btn
...
btn-help = ❓ Помощь
btn-basic = 🔰 Купить Basic
btn-standard = 💎 Купить Standard
btn-premium = 👑 Купить Premium
btn-back = ⬅️ Назад
...
help-my-currencies = 📌 2. 🎯 Мои монеты.
help-my-currencies-desc = В разделе «🎯 Мои монеты» ты можешь:
  - Посмотреть все отслеживаемые монеты
  - Узнать текущие курсы
help-add-currency = 📌 3. Добавить монету в список отслеживания.
help-add-currency-desc = Нажми кнопку «🪙 Выбрать монету». При выборе монеты нажми «☑️ Монета» для отслеживания изменения цены монеты. В зависимости от подписки можно отслеживать от 1 до 10 монет одновременно.
help-set-alert = 📌 4. Настроить уведомления о курсе.
help-set-alert-desc = Нажми «🔔 Настроить уведомления» и выбери монету из списка отслеживаемых. Введите пороговое значение цены (например, верхний порог Bitcoin 99000$). Бот отправит уведомление, когда курс достигнет указанного значения.
help-manage-subscription = 📌 5. Управление подпиской.
...
help-commands = 📌 6. Основные команды:
help-commands-list = 
  /start — Главное меню
  /help — Помощь
...
help-support = ✉️ Служба поддержки: pricealertprobot@outlook.com
#rate
...
subscription-terms-text = 
      ...
      2. Платные подписки
      Basic (200 Stars):
      📈 Мониторинг: До { $basic_limit } монет.
      ⏳ Срок действия: 30 дней.

      Standard (300 Stars):
      📈 Мониторинг: До { $standard_limit } монет.
      ⏳ Срок действия: 30 дней.
      
      Premium (400 Stars):
      📈 Мониторинг: До { $premium_limit } монет.
      ⏳ Срок действия: 30 дней.
...
cmd-support-text =
      ...
      Если у вас возникли вопросы, проблемы с оплатой или функционалом бота, напишите нам: 
      ✉️ pricealertprobot@outlook.com

      ⏰ Часы поддержки: 
      Наша служба поддержки работает с 12:00 до 21:00 (UTC+0).
      ...
      Юридическая оговорка:
      Все подписки являются окончательными, возврат средств не производится. Бот предоставляет исключительно цифровые услуги и не несет ответственности за возможные потери при использовании сервиса.(см. «Условия подписок»).  
      
      Обратите внимание: время ответа может варьироваться.